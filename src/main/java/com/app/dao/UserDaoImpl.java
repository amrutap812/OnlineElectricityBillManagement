...
public class UserDaoImpl implements IUserDao {
	...
	public User authenticateUser(String email, String password) {
		...
		return mgr.createQuery(jpql, User.class).setParameter("email", email).setParameter("password", password).getSingleResult();
	}
	...
	public User getUserDeatils(String email, String phone) {
		...
		User u = mgr.createQuery(jpql, User.class).setParameter("email", email).setParameter("phone", phone).getSingleResult();
		return u;
	}
