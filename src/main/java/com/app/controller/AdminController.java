...
public class AdminController {
	...
	public String showConsumers(Model modelMap) {
		System.out.println("in show consumer list ");
		modelMap.addAttribute("consumer_list", userService.consumerList());
	...
	@PostMapping("/update")
	public String processUpdateConsumerForm(User u, @RequestParam int cid, BindingResult res,
	...
	public String showBillForm(@RequestParam int cid, Bill b, Model modelMap) {
		System.out.println("in show generate_bill form");
		try {
			User c = userService.getConsumer(cid);
			if (c != null) {
	...
	//add a req handling method to show or display bill report for all Consumers : Bill : status : NOT_PAID
	@GetMapping("/bill_report")
	public String showBillReport(@RequestParam int cid, Model modelMap) {
		System.out.println("in show bill report");
		modelMap.addAttribute("bill_report", billService.billReport(cid));
	...
	public String showPaymentReport(@RequestParam int cid, Model modelMap) {
		System.out.println("in show bill report");
		modelMap.addAttribute("payment_report", paymentService.paymentReport(cid));
