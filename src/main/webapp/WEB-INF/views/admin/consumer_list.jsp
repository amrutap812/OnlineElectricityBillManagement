	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				aria-controls="collapseTwo"> <i class="fas fa-user"></i> <span style="font-size: 1.2em;">Add
						User</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed"
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<table border="1" class="table">
						<caption>Available Consumer List</caption>
						...
						<tbody>
							<c:forEach var="c" items="${requestScope.consumer_list}">
								<tr>
									<td>${c.id}</td>
									...
									<td>${c.state}</td>
									<td><a
										href="<spring:url value='/admin/update?cid=${c.id}'/>"><input
											type="button" value="Update" class="btn btn-outline-success"></a></td>
									<td><a
										href="<spring:url value='/admin/delete?cid=${c.id}'/>"><input
											type="button" value="Delete" class="btn btn-outline-danger"></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
