...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				<span class="img-profile rounded-circle">
					<span class="sidebar-brand-text mx-3">
						<img src="./../resources/images/bulb.gif" height="70px" width="224.5px" alt="">
					</span>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/admin/search'/>"
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="col-lg-7">
							...
							<form method="GET" action="<spring:url value='/admin/payment_report'/>" >
