	...
	<div id="wrapper">
		...
		<ul
			...
			<span
				...
				<span class="img-profile rounded-circle"> <span
					class="sidebar-brand-text mx-3"> <img
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/sub_admin/consumers'/>" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-users"></i>
					<span style="font-size: 1.2em;">View Consumer</span>
			</a></li>

			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/sub_admin/search'/>" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-tasks"></i>
					<span style="font-size: 1.2em;">Generate Bills</span>
			</a></li>

			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/sub_admin/search_bill_report'/>"
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-tasks"></i> <span style="font-size: 1.2em;">Bill Report</span>
			</a></li>

			<li class="nav-item"><a class="nav-link collapsed"
				href="<spring:url value='/sub_admin/search_payment_report'/>"
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-tasks"></i> <span style="font-size: 1.2em;">Payment Report</span>
			</a></li>
