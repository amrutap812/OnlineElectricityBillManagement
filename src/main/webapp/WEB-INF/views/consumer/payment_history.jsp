           ...
           <a class="sidebar-brand d-flex align-items-center justify-content-center bg-white" href="/">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="/">
                ...
                <span style="font-size:1.5em;">Dashboard</span></a>
            </li>
                      
            <hr class="sidebar-divider">

            <li class="nav-item">
              <a class="nav-link collapsed" href="<spring:url value='/consumer/home'/>" aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-home"></i>
                <span style="font-size:1.2em;">Home</span>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link collapsed" href="<spring:url value='/consumer/profile'/>" aria-expanded="true" aria-controls="collapseTwo">
			...
			<div id="content">
					...
					<ul class="navbar-nav ml-auto col-12">
						...
						<li class="nav-item dropdown no-arrow align-self-md-right">
							...
							<div
								...
								<a class="dropdown-item" href="<spring:url value='/user/logout'/>" data-toggle="modal" data-target="#logoutModal">Logout</a>
							</div>
						</li>
				...
				<div class="container-fluid">
					...
					<table border="1" class="table">
						...
						<tbody>
							<c:forEach var="p" items="${requestScope.bill_history}">
								<tr align="center">
									<td>${p.id}</td>
									<td>${p.userId}</td>
									<td>${p.billId}</td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<spring:url value='/user/logout'/>">Logout</a>
        </div>
      </div>
    </div>
  </div>
