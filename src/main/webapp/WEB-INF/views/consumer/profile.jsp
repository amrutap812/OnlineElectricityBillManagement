	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-user"></i style="font-size:1.2em;"> <span style="font-size:1.2em;">Profile</span>
			</a></li>
					...
					<div class="col-xl-8 mb-4">
						...
						<div class="card shadow mb-4">
							...
							<h5 align="center" style="color: green;">${requestScope.message}</h5>
								<h5 class="m-0 font-weight-bold text-info">Consumer Details</h5>
							</div>
							...
							<div class="card-body row">
								...
								<a href="<spring:url value='/consumer/update?cid=${sessionScope.user_details.id}'/>"><input
